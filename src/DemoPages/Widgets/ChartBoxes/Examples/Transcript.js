    ...
    return(
        <>
            ...
            <div className="Sort">
                ...
                <Button outline className="mb-2 me-2 btn-transition btn-primary " color="primary" style={{display:"flex",width:"8%",height:"34px",marginTop:"9px"}}>
            ...
            <strong style={{width:'130px' , display:'flex',justifyContent:"space-between", marginLeft:"20px",marginTop:"5px"}}>
                ...
                <div style={{width:'300px' , display:'flex', marginLeft:"20px",marginTop:"5px"}}>
                <i className="pe-7s-check" style={{fontSize:"25px",color:"green",marginLeft:"12px",marginTop:"15px"}}></i>
                      <p style={{marginTop:"16px",marginLeft:"10px"}}> Học phần đậu</p>
                      <i className="pe-7s-close-circle" style={{fontSize:"25px",color:"red",marginLeft:"12px",marginTop:"15px"}}></i>
            ...
            <Card className="mb-3" body inverse color="danger">
                        ...
                        <br></br>    - Sinh viên kiểm tra thông tin đăng ký lớp học ôn - thi tin chuẩn đầu ra, điểm số, kết quả và cấp phát bằng theo <a href="/" style={{textDecoration:"none",color:" #0c1272",fontWeight:"bold"}}>link sau. (TIN HỌC)</a>

                        <br></br>        - Sinh viên kiểm tra thông tin đăng ký lớp học ôn - thi ngoại ngữ đầu ra, điểm số, kết quả và cấp phát bằng theo <a href="/"  style={{textDecoration:"none",color:" #0c1272",fontWeight:"bold"}}>link sau. (NGOẠI NGỮ)</a>
