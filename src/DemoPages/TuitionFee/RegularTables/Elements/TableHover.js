              ...
              <div className="Table--left1">
                <div className="Table--left1--content">
                  <div className="Tongno">
                    ...
                    >
                      <div style={{ fontWeight: "700" }}>Học phí nợ</div>
                      <div style={{ fontSize: "45px" }}>{Tongconlai(0)}</div>
                    </div>
                  </div>
                </div>
              </div>{" "}
                    ...
                    <div className="item">
                      ...
                      <div style={{ width: "550px", marginLeft: "100px" }}>
                        ...
                        <div style={{ width: "auto" }}>
                          {" "}
                          {convertDigitIn(item.ngayTao.substring(0, 10))}
                        </div>
                      </div>
                      <div style={{ height: "100%", marginLeft: "-220px" }}>
                        ...
                        <div
                          className="itemDetail"
                          style={{ width: "150px", margin: " 4px 0 0 0px" }}
                        >
                          Mã học kỳ: {item.hkma}
                        </div>
                        <div
